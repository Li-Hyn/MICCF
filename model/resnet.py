...
def ResNet50(low_dim=128):
    net = resnet.ResNet(resnet.BasicBlock, [3, 4, 6, 3], low_dim)
    net.conv1 = nn.Conv2d(3, 64, kernel_size=3,
                          stride=1, padding=1, bias=False)
    net.maxpool = nn.Identity()
    return net
...
#
#     def _forward_impl(self, x: Tensor, change) -> Tensor:
...
#         return x
#
#     def forward(self, x: Tensor, change) -> Tensor:
#         return self._forward_impl(x, change)
#
#
# def _resnet(
#     block: Type[Union[BasicBlock, Bottleneck]],
...
#
#
# def generateResNet18(low_dim=128, change=True):
#     net = ResNet(BasicBlock, [2, 2, 2, 2], low_dim, change)
#     net.conv1 = nn.Conv2d(3, 64, kernel_size=3,
#                           stride=1, padding=1, bias=False)
#     net.maxpool = nn.Identity()
#     return net
